...
#
#   File: bin/setup-openmandriva.sh
#
...
bld_packages=(
    ...
    # Optional build tools:     # Required by:
        ...
        #~ pandoc                      # Man page, metainfo.   # No pandoc in OpenMandriva.
...
dev_packages=(
    # Optional build tools:     # Required by:
        ...
        #~ pandoc                      # HTML pages.           # No pandoc in OpenMandriva.
        rpm-build                   # RPM package.
    ...
    # Optional test tools:      # Required by:
        ...
        #~ cppcheck                    # Source.               # No cppcheck in OpenMandriva.
